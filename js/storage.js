...
const Store = (() => {
  const SNAPSHOT_KEY = "cseTracker.dataSnapshot";
  ...
  function setRaw(key, value) {
    ...
    if (key.startsWith(DATA_PREFIX) && !LOCAL_ONLY_KEYS.has(key)) rebuildSnapshot();
  }
  ...
  return {
    ...
    exportAll, importAll,
    setRaw, removeRaw, rebuildSnapshot, restoreSnapshot,
    getSnapshot: rebuildSnapshot,
  };
})();
